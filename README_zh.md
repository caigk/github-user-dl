...
本工具支持**英文**和**中文**两种语言。默认语言跟随系统设置：

- **英文：** 当系统语言为英文时（如 `LANG=en_US.UTF-8`）
- **中文：** 当系统语言为中文时（如 `LANG=zh_CN.UTF-8`）

您也可以强制指定语言：
```bash
LANG=en_US.UTF-8 ./gh-user-dl -u username  # 英文输出
LANG=zh_CN.UTF-8 ./gh-user-dl -u username  # 中文输出
```